...
const translations = {
  en: {
    ...
    neverMissDesc: "Your ToolTime Assistant works around the clock to answer questions, capture leads, and book appointments — even when you're off the clock.",
    features: [
    ...
    readyCaptureDesc: 'Get your own ToolTime Assistant that works 24/7 to answer questions, capture leads, and book appointments. Setup takes less than 10 minutes.',
  ...
  es: {
    ...
    neverMissDesc: 'Su ToolTime Assistant trabaja las 24 horas para responder preguntas, capturar clientes y agendar citas — incluso cuando usted no está trabajando.',
    features: [
    ...
    readyCaptureDesc: 'Obtenga su propio ToolTime Assistant que trabaja 24/7 para responder preguntas, capturar clientes y agendar citas. La configuración toma menos de 10 minutos.',
