      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-[#1a1a2e] mb-2">Never Miss Another Lead</h2>
              <p className="text-gray-600">
                Your AI chatbot works around the clock to answer questions, capture leads, and book appointments — even when you&apos;re off the clock.
              </p>
            </div>
            ...
            <div className="mt-8 w-full max-w-[380px]">
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-[#f5a623] to-[#ffc107] px-4 py-2 flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#1a1a2e]">NEW LEAD CAPTURED</span>
                </div>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-[#1a1a2e]">Mike</div>
                        <div className="text-sm text-gray-500">555-123-4567</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm font-medium text-[#1a1a2e]">Pool cleaning</div>
        ...
        <div className="mt-16 bg-gradient-to-r from-[#1a1a2e] to-[#2d2d4a] rounded-2xl p-8 md:p-12 text-center text-white">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Capture More Leads?</h2>
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Get your own AI chatbot that works 24/7 to answer questions, capture leads, and book appointments. Setup takes less than 10 minutes.
          </p>
          ...
          <p className="text-white/60 text-sm mt-6">No credit card required. Free 14-day trial.</p>
        </div>
      </div>
    </div>
  );
