...
const PRODUCTS = [
  { id: 'starter', name: 'Task Iguana — Starter', description: 'Owner + 2 workers. Website, booking, quoting, invoicing, GPS, Shield, Jenny Lite.', prices: [{ key: 'monthly', amount: 4900, interval: 'month' }, { key: 'annual', amount: 49000, interval: 'year' }] },
  { id: 'pro', name: 'Task Iguana — Pro', description: 'Up to 15 workers. Everything in Starter + Reviews, Jenny Lite, dispatch, QuickBooks.', prices: [{ key: 'monthly', amount: 7900, interval: 'month' }, { key: 'annual', amount: 79000, interval: 'year' }] },
  { id: 'elite', name: 'Task Iguana — Elite', description: 'Unlimited workers. Everything in Pro + Jenny Pro, Dispatch, Routes, Portal Pro, QB.', prices: [{ key: 'monthly', amount: 12900, interval: 'month' }, { key: 'annual', amount: 129000, interval: 'year' }] },
  { id: 'booking_only', name: 'Task Iguana — Booking Only', description: 'Online booking page only.', prices: [{ key: 'monthly', amount: 1500, interval: 'month' }, { key: 'annual', amount: 15000, interval: 'year' }] },
  { id: 'invoicing_only', name: 'Task Iguana — Invoicing Only', description: 'Invoicing and card payments only.', prices: [{ key: 'monthly', amount: 1500, interval: 'month' }, { key: 'annual', amount: 15000, interval: 'year' }] },
  { id: 'jenny_lite', name: 'Jenny Lite — Task Iguana Assistant', description: '24/7 chatbot. Lead capture, FAQ, booking. Bilingual. Included free with all plans.', prices: [{ key: 'monthly', amount: 1900, interval: 'month' }, { key: 'annual', amount: 19000, interval: 'year' }] },
  { id: 'jenny_pro', name: 'Jenny Pro — AI Phone Receptionist', description: 'AI phone 24/7, bilingual voice, SMS, booking, emergencies. Add-on for any plan.', prices: [{ key: 'monthly', amount: 4900, interval: 'month' }, { key: 'annual', amount: 49000, interval: 'year' }] },
