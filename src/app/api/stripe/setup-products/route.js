...
const PRODUCTS = [
  ...
  { id: 'elite', name: 'ToolTime Pro — Elite', description: 'Unlimited workers. Everything in Pro + Jenny Pro, Dispatch, Routes, Portal Pro, QB.', prices: [{ key: 'monthly', amount: 12900, interval: 'month' }, { key: 'annual', amount: 129000, interval: 'year' }] },
  ...
  { id: 'jenny_lite', name: 'Jenny Lite — ToolTime Assistant', description: '24/7 chatbot. Lead capture, FAQ, booking. Bilingual. Included free with all plans.', prices: [{ key: 'monthly', amount: 1900, interval: 'month' }, { key: 'annual', amount: 19000, interval: 'year' }] },
