...
const features = [
  ...
  { title: 'Customer Portal Pro', description: 'Give customers a branded portal with live job tracker, photo gallery, messaging, document vault, and service history. $24/mo or included with Elite.', badge: '🌟 NEW', highlight: true },
