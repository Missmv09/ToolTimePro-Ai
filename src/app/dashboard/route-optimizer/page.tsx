    ...
    Promise.all([
      ...
      pointsToShow.forEach((point, index) => {
        ...
        const icon = L.default.divIcon({
          ...
          html: `<div style="
            ...
            background: ${isOptimized ? '#22c55e' : '#1FE3C4'};
      ...
      if (pointsToShow.length >= 2) {
        ...
        const polyline = L.default.polyline(latLngs, {
          color: isOptimized ? '#22c55e' : '#1FE3C4',
          weight: 4,
          opacity: 0.8,
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-gradient-to-br from-[#1FE3C4] to-[#e6991a] rounded-xl flex items-center justify-center">
            <Route className="w-6 h-6 text-[#0A0C11]" />
          </div>
          <div>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#0A0C11] text-white rounded-lg text-sm font-medium hover:bg-[#2d2d44] transition-colors"
        >
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${showSettings ? 'bg-[#0A0C11] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${showSavedRoutes ? 'bg-[#0A0C11] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${showMultiWorker ? 'bg-[#0A0C11] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
      ...
      {showSettings && (
        <div className="mb-6 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#0A0C11] text-white rounded-lg text-sm font-medium hover:bg-[#2d2d44] disabled:opacity-60"
          >
        ...
        <div className="mb-6 bg-white border border-gray-200 rounded-xl p-5">
          ...
          {fieldWorkers.length > 0 ? (
            <>
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center gap-2 px-3 py-2 border rounded-lg cursor-pointer transition-colors ${
                        checked ? 'border-[#0A0C11] bg-gray-50' : 'border-gray-200 hover:bg-gray-50'
                      }`}
                    >
                      <input
                        type="checkbox"
              ...
              {selectedWorkerIds.length > 0 && (
                <p className="text-xs text-[#1FE3C4] mt-3 font-medium">
      ...
      {optimizedResult?.workerRoutes && optimizedResult.workerRoutes.length > 0 && (
        <div className="mb-6 bg-white border border-gray-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            <Users className="w-5 h-5 text-[#0A0C11]" />
      ...
      <div className="mb-6">
        {jobs.length === 0 ? (
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-[#1FE3C4] to-[#e6991a] text-[#0A0C11] rounded-xl font-bold text-lg hover:from-[#e6991a] hover:to-[#d98f15] transition-all disabled:opacity-70"
          >
            {isOptimizing ? (
          ...
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-[#1FE3C4] to-[#e6991a] text-[#0A0C11] rounded-xl font-bold hover:from-[#e6991a] hover:to-[#d98f15] transition-all"
              >
                {t('reOptimize')}
              </button>
            </div>
            <div className="flex gap-2 items-center">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#0A0C11] text-white rounded-lg text-sm font-medium hover:bg-[#2d2d44] disabled:opacity-60"
              >
      ...
      {displayJobs.length > 0 && (
        <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 ${
                        optimizedResult ? 'bg-green-500' : 'bg-[#1FE3C4]'
                      }`}
                    >
                      {index + 1}
                    </div>
          ...
          {/* Daily Summary */}
          <div className="mt-6 bg-[#0A0C11] rounded-xl p-5 text-white">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-[#1FE3C4]">
