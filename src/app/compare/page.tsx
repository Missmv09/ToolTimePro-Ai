    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              ...
              <h3 className="font-bold text-[#1a1a2e]">AI-Native</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              ...
              <h3 className="font-bold text-[#1a1a2e]">Compliance-Built</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              ...
              <h3 className="font-bold text-[#1a1a2e]">Bilingual</h3>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-[#1a1a2e] mb-3">Choose Your Comparison</h2>
