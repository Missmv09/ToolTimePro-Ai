    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-[#0A0C11] mb-3">{t('chooseComparison')}</h2>
          ...
          <div className="space-y-6">
            {competitors.map(comp => (
              <Link
                ...
                className="block bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg hover:border-[#1FE3C4] transition-all p-6 no-underline"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-[#0A0C11]">{comp.tagline}</h3>
