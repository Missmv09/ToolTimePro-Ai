...
const jennyFeatures = [
  {
    ...
    name: 'Jenny Answers',
    icon: '📞',
    tagline: 'Never miss a call — or a text — again',
    description: 'Your 24/7 AI receptionist that turns missed calls and texts into booked jobs — capturing leads, scheduling, and escalating emergencies, all on your own number while you focus on the job.',
    capabilities: [
      'Answers every call and text instantly, even at 2 AM',
      'Texts customers back and books them by SMS',
      'Captures name, phone, address, and service details',
      'Books appointments directly into your calendar',
      'Works on your own number — or a new one in seconds',
