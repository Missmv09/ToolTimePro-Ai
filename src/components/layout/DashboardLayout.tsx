        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-navy-100 rounded-full flex items-center justify-center">
              <span className="text-sm font-medium text-navy-500">JD</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-navy-500 truncate">John Doe</p>
              <p className="text-xs text-gray-500 truncate">Owner</p>
            </div>
            <button className="p-2 text-gray-400 hover:text-navy-500 transition-colors">
              <LogOut size={18} />
            </button>
          </div>
        </div>
