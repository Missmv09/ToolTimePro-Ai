...
const SOURCE_TO_WIKI = [
  ...
  { prefix: 'src/app/dashboard/compliance/',       wiki: 'Shield-Iguana.md' },
  { prefix: 'src/app/dashboard/shield/',           wiki: 'Shield-Iguana.md' },
  { prefix: 'src/app/dashboard/hr-toolkit/',       wiki: 'Shield-Iguana.md' },
