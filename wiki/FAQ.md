...
See [Pricing & Plans](Pricing-and-Plans) for full details.

### Are there per-user fees?
No hidden per-user fees on any plan. Extra workers beyond your plan limit are $7/month each — that's it.

### Can I change plans later?
Yes. Upgrade or downgrade anytime from **Settings** → **Billing**. Changes take effect at the next billing cycle. Upgrades mid-cycle are prorated.

### Do you offer annual billing?
Yes. Annual plans save approximately 2 months (e.g., Starter is $490/year instead of $588 paid monthly).

### What if I just need booking or invoicing?
We offer standalone plans at **$15/month** each:
- **Booking Only** — Online booking page, scheduling, and reminders
- **Invoicing Only** — Professional invoices, card payments, and tracking
...
### What is Jenny AI?
Jenny AI is your AI-powered back-office assistant. She handles customer communication, lead capture, scheduling, and more — included with every plan.

### What's the difference between Jenny Lite, Pro, and Exec?
| Tier | Price | What It Does |
|------|-------|-------------|
| **Jenny Lite** | Free (included) | Website chatbot, lead capture, FAQ answering, bilingual |
| **Jenny Pro** | $49/mo | AI phone answering 24/7, SMS, bilingual voice, booking, emergency escalation |
| **Jenny Exec Admin** | $79/mo | Compliance advisor, HR law monitoring, workforce analytics |

### Can Jenny AI speak Spanish?
Yes. Jenny handles conversations in both English and Spanish across chat, phone (Jenny Pro), and SMS.
...
Go to **Team** → **+ Add Team Member**. Enter their details, set their role, and send an invite. They'll get an email to set up their account.
...
### Can workers use the app in Spanish?
Yes. Workers can switch to Spanish from their profile settings.
...
A customer-facing portal where your clients can track jobs, view before/after photos, message you, access documents, and see service history. Included with Elite or available as an add-on for $24/month.
...
Most businesses are up and running in **1–2 weeks**. Add your services, invite your team, connect payments — and you're dispatching.
...
We typically respond within 2 hours during business hours. Elite plan customers get priority support with a dedicated account manager.

### Is there a knowledge base?
You're looking at it! Browse the [Help Center](Home) for guides on every feature.
