...
| Endpoint | Methods | Source |
|----------|---------|--------|
| `/api/help/ask-jenny` | `POST` | `src/app/api/help/ask-jenny/route.js` |
...
| Endpoint | Methods | Source |
|----------|---------|--------|
| `/api/website-builder/connect-domain` | `POST` | `src/app/api/website-builder/connect-domain/route.js` |
