...
-- Base schema + migrations (minus redundant/superseded ones).
-- SKIPPED: 20260128..._add_quickbooks_tables (already in schema.sql)
-- SKIPPED: 20260411..._fix_quickbooks_schema (already applied in schema.sql)
...
-- >>> SKIPPED MIGRATION: 20260128000000_add_quickbooks_tables.sql (superseded by schema.sql) <<<
...
-- >>> SKIPPED MIGRATION: 20260411000000_fix_quickbooks_schema.sql (superseded by schema.sql) <<<
