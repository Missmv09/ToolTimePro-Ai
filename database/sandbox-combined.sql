...
-- ==========================================================
-- Legacy numbered migrations (database/migrations/)
-- ==========================================================
...
-- ==========================================================
-- Newer timestamped migrations (supabase/migrations/)
-- ==========================================================

-- >>> SKIPPED: 20260128000000_add_quickbooks_tables.sql (already in schema.sql) <<<
...
-- >>> SKIPPED: 20260411000000_fix_quickbooks_schema.sql (already applied; references columns that never existed on fresh DB) <<<

-- >>> SKIPPED: 20260411000001_fix_invoice_items_rls.sql (duplicate of database/migrations/031_fix_invoice_items_rls.sql) <<<
...
-- >>> SKIPPED: 20260415000000_fix_missing_rls_policies.sql (duplicate of database/migrations/032_fix_missing_rls_policies.sql) <<<

-- >>> SKIPPED: 20260416000000_cascade_delete_company_fks.sql (duplicate of database/migrations/033_cascade_delete_company_fks.sql) <<<
